...
que el modelo lo absorbió en la tendencia. STL detecta sorpresas locales, no cambios estructurales graduales.""",
        ...
        "an_anom_explained":        "Anomalía explicada",
        "an_anom_unexplained":      "Anomalía sin explicar",
        "an_anom_only_unexplained": "Mostrar solo anomalías sin explicar",
...
that the model absorbed it into the trend. STL detects local surprises, not gradual structural shifts.""",
        ...
        "an_anom_explained":        "Explained anomaly",
        "an_anom_unexplained":      "Unexplained anomaly",
        "an_anom_only_unexplained": "Show only unexplained anomalies",
