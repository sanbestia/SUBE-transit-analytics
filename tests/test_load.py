...
class TestLoad:
    ...
    def test_monthly_aggregation_sums_correctly(self, loaded_conn):
        # Jan 2024 COLECTIVO total: 50000 + 15000 + 48000 + 52000 = 165000
...
class TestCreateViews:
    ...
    def test_v_weekday_heatmap_covers_all_days(self, loaded_conn):
        ...
        # We have Mon(0), Tue(1), Wed(2) in the data
...
class TestQuery:
    def test_returns_dataframe(self, loaded_conn):
        ...
        with patch("etl.load.get_connection", return_value=loaded_conn):
            result = query("SELECT COUNT(*) AS n FROM daily_transactions", conn=loaded_conn)
